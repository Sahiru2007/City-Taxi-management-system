...
const OperatorReseravtion = () => {
  ...
  const handleBook = async () => {
    ...
    try {
      if (!selectedDriver || !pickupLocation || !destination || !selectedTime || !passengerName || !passengerContact) {
        const errorDiv = document.getElementById('error');
        if (errorDiv) {
          errorDiv.innerHTML = 'Please select a driver, pickup location, destination, time passenger name and thier contact number';
        }
...
if (errorDiv) {
  errorDiv.innerHTML = '';
      ...
      const bookingData = {
        ...
        passengerContactNumber: passengerContact,
  ...
  return (
    ...
    <div className="mt-5">
     ...
     <label className="text-lg font-semibold ">Time</label>
              ...
              <div className="flex flex-col gap-1">
              <label className="text-lg font-semibold">Passenger Contact Number</label>
...
export default OperatorReseravtion;
